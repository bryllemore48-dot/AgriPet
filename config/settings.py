...
SECRET_KEY = os.getenv(
    'SECRET_KEY',
    'django-insecure-sm)j940-el#4tal&z8)e(ddj%x^h80a+bqf69w#9mjy@y^_ib9',
)
...
# Trust Render's proxy headers so CSRF and HTTPS work correctly
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', EMAIL_HOST_USER or 'noreply@agripet.local')
